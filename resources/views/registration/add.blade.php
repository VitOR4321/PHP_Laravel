...
<form action="<?=config('app.url');?>/public/registration/save " method="POST">
@csrf
...
<div class="form-group">
    ...
    <select id="department" name="department" class="form-select" name="department" required>
  ...
  <button type="submit" class="btn btn-primary" style="margin-bottom:15px;margin-top:15px">Zapisz się</button>
</form>
      <p>
          @if($errors->any())
